...
if __name__ == "__main__":
    ...
    player1_depth_limit = sys.argv[3] if len(sys.argv) > 3 else depth_limit
    player2_depth_limit = sys.argv[4] if len(sys.argv) > 4 else depth_limit
    # player1_depth_limit = 1
    # player2_depth_limit = 1
    
  
    player1 = build_player(player1_type, player1_sign , int(player1_depth_limit))
    player2 = build_player(player2_type, player2_sign , int(player2_depth_limit))
    ...
    # game.console.output(f"player1_type: {player1_type},{player1_sign}-depth = {player1_depth_limit}, player2_type: {player2_type}, {player2_sign}-depth = {player2_depth_limit}")
    # print(results)